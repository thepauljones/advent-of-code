...
class Monkey:
    ...
    def take_turn(self, all_monkeys, worryMod):
...
all_test_values = list(map(lambda x: x.test, monkeys))
worryMod = math.prod(all_test_values)
...
while rounds < 10000:
    for i in range(0, len(monkeys)):
        monkeys[i].take_turn(monkeys, worryMod)

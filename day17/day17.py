...
def probe_beyond_target(pos):
    return pos[0] > target_x2 or pos[1] < target_y1

Trajectories = {}
def fire_probe(pos, vel):
    ...
    return fire_probe((posX, posY), (velX, velY))
...
# test_cases = [(23,-10),  (25,-9),   (27,-5),   (29,-6),   (22,-6),   (21,-7),   (9,0),     (27,-7),   (24,-5),
